  ...
  void filterSearchResults(String query){
    ...
    if(query.isNotEmpty){
      ...
      for(int i=0;i<dummySearchList.length;i++){
        if((dummySearchList[i]['name']).toLowerCase().contains(query.toLowerCase())){
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(width: 2,color: Colors.grey[100]),
                )
              ),
            ),
          ),
                    ...
                    child: Card(
                      ...
                      child: ListTile(
                        ...
                        leading: CircleAvatar(
                          radius: 25,
                          backgroundColor: Colors.grey[800],
                          backgroundImage: AssetImage('assets/${items[index]['code'].toLowerCase()}.png'),
                        ),
                      ),
                    ),
                  );
